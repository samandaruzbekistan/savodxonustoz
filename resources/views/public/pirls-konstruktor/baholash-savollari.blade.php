...
<div class="flex gap-6 -mt-2">
    ...
    <div class="min-w-0 flex-1">
        ...
        {{-- Header --}}
        <div class="relative mb-6 overflow-hidden rounded-3xl border border-rose-100 bg-gradient-to-br from-rose-50 via-amber-50 to-sky-50 px-6 py-7 sm:px-8">
            <div class="pointer-events-none absolute -left-14 -top-16 h-56 w-56 rounded-full bg-rose-300/25 blur-3xl"></div>
            <div class="pointer-events-none absolute -right-10 -bottom-20 h-64 w-64 rounded-full bg-amber-300/25 blur-3xl"></div>

            <div class="relative flex flex-wrap items-center justify-between gap-6">
                <div class="min-w-0 flex-1">
                    <div class="flex items-center gap-3 mb-2">
                        <span class="inline-flex h-8 w-8 items-center justify-center rounded-full text-sm font-bold bg-rose-600 text-white shadow-sm">5</span>
                        <span class="text-xs text-rose-700/80 uppercase tracking-wide font-bold">PIRLS topshiriqlari konstruktori • 5-bo'lim</span>
                    </div>
                    ...
                    <div class="mt-4">
                        <span class="inline-flex items-center gap-1.5 rounded-full bg-white/80 border border-rose-200 px-3 py-1.5 text-xs font-semibold text-rose-700 shadow-sm backdrop-blur">
                            <x-icon name="star" class="h-3.5 w-3.5" /> 4-daraja savollari
                        </span>
                    </div>
                </div>

                <img src="{{ asset('images/sections/pirls-konstruktor/12_baholash_checklist.png') }}" alt="Baholash savollari"
