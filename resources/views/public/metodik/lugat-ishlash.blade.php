    ...
    <div class="min-w-0 flex-1">
        ...
        <div class="relative mb-8 overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-950 via-indigo-900 to-violet-900 p-7 shadow-sm sm:p-9">
            ...
            <div class="relative z-10 flex items-center gap-6">
                ...
                <div class="hidden shrink-0 items-center justify-center rounded-2xl bg-white/95 p-4 shadow-xl md:flex">
                    <img src="{{ asset('images/'.rawurlencode('metodik modul').'/'.rawurlencode("Lug'at ustida ishlash.png")) }}" alt="" class="h-32 w-44 object-contain">
                </div>
            </div>
        </div>
        ...
        <div class="mb-8 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            <div class="grid grid-cols-1 md:grid-cols-[220px_1fr]">
                <img src="{{ asset('images/metodik/lugat-ishlash/yonalishlar.jpg') }}" alt="O'qituvchi bolalar bilan lug'at ustida ishlamoqda" class="hidden h-full max-h-56 w-full object-cover md:block">
                <div class="p-5">
                    <h2 class="mb-4 text-xs font-bold uppercase tracking-wide text-slate-400">Lug'at ustida ishlash yo'nalishlari</h2>
                    <div class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                        @foreach ([
                            ...
                            <div class="flex items-start gap-2 rounded-xl border border-slate-200 p-3 transition hover:border-indigo-200 hover:bg-indigo-50/50">
        ...
        {{-- Amaliy metodlar --}}
        <div class="mb-8 overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
            <img src="{{ asset('images/metodik/lugat-ishlash/amaliy-metodlar.jpg') }}" alt="O'quvchilar sinfda birga o'qimoqda" class="h-36 w-full object-cover">
            <div class="p-5">
                <h2 class="mb-4 text-xs font-bold uppercase tracking-wide text-slate-400">Amaliy metodlar</h2>
                <div class="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                    @foreach ([
                        ['n'=>1,'title'=>"So'z xaritasi",'desc'=>"O'quvchi yangi so'z atrofida uning ma'nosi, sinonimi, antonimi, rasmli ifodasi va gapdagi qo'llanishini yozadi.",'tint'=>'bg-indigo-50 text-indigo-600'],
                        ['n'=>2,'title'=>'Kontekstdan top','desc'=>"O'quvchi so'z ma'nosini matndagi boshqa gaplar yordamida taxmin qiladi.",'tint'=>'bg-violet-50 text-violet-600'],
                        ['n'=>3,'title'=>'Rasm va so\'z','desc'=>"Yangi so'zga mos rasm ko'rsatiladi yoki o'quvchi o'zi rasm chizadi.",'tint'=>'bg-sky-50 text-sky-600'],
                        ['n'=>4,'title'=>"Sinonimlar zanjiri",'desc'=>"O'quvchilar bir so'zga ma'nodosh so'zlar topadilar.",'tint'=>'bg-blue-50 text-blue-600'],
                        ['n'=>5,'title'=>"Yangi so'z bilan gap tuz",'desc'=>"O'quvchi yangi so'zni o'z gapi ichida ishlatadi.",'tint'=>'bg-emerald-50 text-emerald-600'],
                        ['n'=>6,'title'=>"Kalit so'zlar",'desc'=>"O'quvchi matnning asosiy mazmunini ochuvchi so'zlarni ajratadi.",'tint'=>'bg-teal-50 text-teal-600'],
                    ] as $m)
                        <div class="rounded-2xl border border-slate-200 p-4 transition hover:-translate-y-0.5 hover:shadow-sm">
                            <div class="mb-2 flex items-center gap-2.5">
                                <span class="grid h-8 w-8 shrink-0 place-items-center rounded-lg text-sm font-bold {{ $m['tint'] }}">{{ $m['n'] }}</span>
        ...
        <div class="mb-8 grid grid-cols-1 gap-4 md:grid-cols-2">
            ...
            <div class="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm">
                <img src="{{ asset('images/metodik/lugat-ishlash/mashq.jpg') }}" alt="O'quvchilar birga yozmoqda" class="h-32 w-full object-cover">
                <div class="p-5">
                    <div class="mb-3 flex items-center gap-2.5">
                    ...
                    <ol class="space-y-1.5">
                        @foreach ([
                            ...
                            <li class="flex items-start gap-1.5 text-xs text-slate-500">
                                <span class="inline-flex h-4 w-4 shrink-0 items-center justify-center rounded-full bg-indigo-100 text-indigo-700 font-bold text-[9px]">{{ $i+1 }}</span>
                                {{ $task }}
                            </li>
                        @endforeach
                    </ol>
        ...
        <div class="mb-8">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-[1fr_1fr_auto] md:items-stretch">
                ...
                <div class="hidden overflow-hidden rounded-2xl border border-slate-200 md:block md:w-36">
                    <img src="{{ asset('images/metodik/lugat-ishlash/namuna.jpg') }}" alt="O'quvchi kitob o'qimoqda" class="h-full w-full object-cover">
                </div>
            </div>
        </div>
        ...
        <div class="mb-6 rounded-2xl border border-emerald-200 bg-emerald-50 p-6">
            <h3 class="mb-3 text-sm font-bold uppercase tracking-wide text-emerald-900">Bo'lim yakuni</h3>
