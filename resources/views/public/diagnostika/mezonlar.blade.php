...
<div class="flex gap-6 -mt-2">
    ...
    <div class="min-w-0 flex-1">
        ...
        @php $file = '2. 0-3 ballik baholash mezonlari.docx'; $fp = public_path("files/diagnostika/{$file}"); @endphp
        @if(file_exists($fp))
        <div class="mb-5 rounded-2xl border border-slate-200 bg-white overflow-hidden">
            ...
            <div class="px-5 py-3.5 flex items-center gap-4">
                ...
                <div class="flex-1"><p class="text-sm font-medium text-slate-800">0–3 ballik baholash mezonlari</p><p class="text-xs text-slate-500">DOCX &middot; {{ round(filesize($fp)/1024) }} KB</p></div>
