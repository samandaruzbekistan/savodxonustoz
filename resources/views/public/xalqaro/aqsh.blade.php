...
<div class="flex gap-6 -mt-2">
    ...
    <div class="min-w-0 flex-1">
        ...
        <div class="relative mb-6 overflow-hidden rounded-2xl p-6 text-white">
            <div class="absolute inset-0 bg-cover bg-center" style="background-image: url('{{ asset('images/aqsh.jpeg') }}')"></div>
            <div class="absolute inset-0 bg-gradient-to-br from-blue-700/85 to-blue-900/85"></div>
        ...
        <x-xalqaro.gallery-strip :images="['aqsh.jpeg', 'xalqaro/aqsh-2.jpg', 'xalqaro/aqsh-3.jpg']" name="AQSH" />
